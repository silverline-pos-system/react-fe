...
import ItemDispatcherScreen from './ItemDispatcherScreen';
import POManagementScreen from './POManagementScreen';
...
import StockValuationScreen from '../store/StockValuationScreen';
import StockAgingScreen from '../store/StockAgingScreen';
...
const InventorySystemContent = () => {
    ...
    useEffect(() => {
        // Close mobile sidebar whenever screen changes.
        // eslint-disable-next-line react-hooks/set-state-in-effect
    ...
    // Function to refresh items (called after Dispatch to update quantities and prices)
