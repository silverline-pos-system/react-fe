...
import { dispatchPaymentService } from '../../services/dispatchPaymentService';
...
export default function DispatchPaymentModal({ isOpen, onClose, branchId, onNotification }) {
    ...
    // If a sub-modal (Pay or Transfer) is open, only show that modal
    const isSubModalOpen = showPayModal || showTransferModal;

    return (
        <>
            {/* Main Dispatch Payment Requests Modal - hidden when sub-modal is open */}
            {!isSubModalOpen && (
            ...
            {/* Pay Modal - renders as standalone top-level modal */}
            ...
            {/* Transfer to Manager Modal - renders as standalone top-level modal */}
