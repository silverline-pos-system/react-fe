                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <form className="bg-white rounded-lg border border-gray-200 p-6" onKeyDown={handleSupplierInfoKeyDown}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {/* Branch selection removed as per user request - POs are global/main branch now */}
                                <div>
                                ...
                                <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y">
                                        ...
                                        {formData.items.length === 0 && (
                                            <tr>
                                                <td colSpan="9" className="px-4 py-8 text-center text-gray-500">No items added yet</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
