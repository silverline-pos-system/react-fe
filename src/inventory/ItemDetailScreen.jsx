...
const ItemDetailScreen = ({
    ...
    // Fetch real-time sales data for this product
    ...
    useEffect(() => {
        ...
        const fetchSales = async () => {
            ...
            try {
                ...
                if (!cancelled) {
                    // Normalize sales data: aggregate by date
                    const dateMap = {};
                ...
                // Ignore silent logs, cancel interval if API doesn't support sales
    ...
    return (
        <div className="space-y-6">
            ...
            {selectedItemTab === 'prices-batches' && (() => {
                ...
                // Extract unique selling prices across all batches
